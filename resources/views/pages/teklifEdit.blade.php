        ...
        <div class="box-body">
            ...
            <div class="box-footer clearfix no-border form-group">
                ...
                <div class="row">
                    ...
                    <input type="number" name="miktar" class="form-control" placeholder="Miktar" required value="{{$data['teklifEdit']->miktar}}">
                    </div>

                    <div class="col-md-4">
                        <label class="text" for="birim">Birim</label>
                        <input type="text" name="birim" class="form-control" placeholder="Birim" required value="{{$data['teklifEdit']->birim}}">
                    </div>

                    <div class="col-md-4">
                        <label class="text" for="malzemeFiyati">Malzeme Fiyatı</label>
                        <input type="number" name="malzemeFiyati" class="form-control" placeholder="Malzeme Fiyatı" required value="{{$data['teklifEdit']->malzemeFiyati}}">
                    </div>
